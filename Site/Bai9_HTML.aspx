<%@ Page Title="Học Thiết Kế HTML" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai9_HTML.aspx.cs" Inherits="HTML_Bai9_HTML" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai9_HTML.aspx" style="color:white;font-weight:bold;">Bài 9: Trích Dẫn Trong HTML</a></p>
