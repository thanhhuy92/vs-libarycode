<%@ Page Title="Học Thiết Kế HTML" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai4_HTML.aspx.cs" Inherits="HTML_Bai4_HTML" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai4_HTML.aspx" style="color:white;font-weight:bold;">Bài 4: Các Thành Phần Của HTML</a></p>
