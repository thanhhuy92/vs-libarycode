<%@ Page Title="Học Lập Trình C" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai8_C.aspx.cs" Inherits="Lap_Trinh_C_Bai8_C" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai8_C.aspx" style="color:white;font-weight:bold;">Bài 8: Cấu Trúc Lặp DO-WHILE</a></p>
