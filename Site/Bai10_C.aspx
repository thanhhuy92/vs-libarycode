<%@ Page Title="Học Lập Trình C" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai10_C.aspx.cs" Inherits="Lap_Trinh_C_Bai10_C" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai10_C.aspx" style="color:white;font-weight:bold;">Bài 10: Dữ Liệu Có Cấu Trúc (STRUCT)</a></p>
    </section>
</asp:Content>
