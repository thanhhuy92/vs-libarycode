...
<asp:Panel ID="Panel1" runat="server">
    <img style="width: 90%; height:200px;margin:0 auto;display:block;margin-bottom:1em;" src="../App_Themes/HienDai/Images/banner-ver1.jpg" />
</asp:Panel>

<asp:Panel ID="Panel2" runat="server">
    <img style="width:90%;height:200px;display:block;margin:0 auto;margin-top:1em;margin-bottom:1em;" src="../App_Themes/HienDai/Images/banner-ver3.jpg" />
</asp:Panel>
