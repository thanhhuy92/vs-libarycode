<%@ Page Title="Học Lập Trình C#" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai9_C_Sharp.aspx.cs" Inherits="Lap_Trinh_C_Sharp_Bai9_C_Sharp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai9_C_Sharp.aspx" style="color:white;font-weight:bold;">Bài 9: Mảng (ARRAY)</a></p>
