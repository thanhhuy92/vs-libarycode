<%@ Page Title="Học Lập Trình C#" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai6_C_Sharp.aspx.cs" Inherits="Lap_Trinh_C_Sharp_Bai6_C_Sharp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai6_C_Sharp.aspx" style="color:white;font-weight:bold;">Bài 6: Cấu Trúc Vòng Lặp FOR</a></p>
