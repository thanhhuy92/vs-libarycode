<%@ Page Title="Học Thiết Kế HTML" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai7_HTML.aspx.cs" Inherits="HTML_Bai7_HTML" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai7_HTML.aspx" style="color:white;font-weight:bold;">Bài 7: Đoạn Văn Trong HTML</a></p>
