<%@ Page Title="Học Thiết Kế HTML" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai8_HTML.aspx.cs" Inherits="HTML_Bai8_HTML" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai8_HTML.aspx" style="color:white;font-weight:bold;">Bài 8: Định Dạng Trong HTML</a></p>
