<%@ Page Title="Học Lập Trình C" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai6_C.aspx.cs" Inherits="Lap_Trinh_C_Bai6_C" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai6_C.aspx" style="color:white;font-weight:bold;">Bài 6: Cấu Trúc Lặp FOR</a></p>
