<%@ Page Title="Học Lập Trình C#" Language="C#" MasterPageFile="~/MasterPages/Frontend.master" AutoEventWireup="true" CodeFile="Bai4_C_Sharp.aspx.cs" Inherits="Lap_Trinh_C_Sharp_Bai4_C_Sharp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <section class="HocC">
        ...
        <p style="background-color:#FFA500;"><a href="Bai4_C_Sharp.aspx" style="color:white;font-weight:bold;">Bài 4: Cấu Trúc Rẽ Nhánh (IF)</a></p>
